...
VAL_PARQUET="${VAL_PARQUET:-${REPO_ROOT}/custom_data/training_prompts/size_2/only_codenames_trial_val.parquet}"
...
JUDGE_MODEL_ID="${JUDGE_MODEL_ID:-cpatonn/Qwen3-30B-A3B-Instruct-2507-AWQ-4bit}"
